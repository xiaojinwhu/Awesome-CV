...
\setmainfont{Roboto}[Path=fonts/, UprightFont=*-Regular.ttf, BoldFont=*-Bold.ttf]
 ...
 \email{xiaojin.fudan@gmail.com}
 \extrainfo{\faicon{bookmark-o} 湖南省张家界市|中共党员}
 %\homepage{xiaojin.online}
 \address{\faicon{map-marker} 上海市徐汇区}{\faicon{graduation-cap} 复旦大学应届硕士生}
 \quote{求职意向：医学信息分析师}
 ...
 \section{教育背景}
  \cventry{2013--2016}{理学硕士}{复旦大学}{生物化学与分子生物学专业}{}{
  	\begin{itemize}
  		\item 主修课程：现代组织化学，基因生理学，\textbf{医学信息检索与利用}等课程。
  	\end{itemize}
  	}
  \cventry{2008--2013}{医学学士}{武汉大学}{医学检验专业}{}{
  	\begin{itemize}
  		\item 主修课程：\textbf{医学统计学}，病理学，生理学，病理生理学，临床生物化学与检验，临床免疫学与检验，诊断学，内外妇儿科学等临床医学与医学检验课程。
  	\end{itemize}
  }
